...
> Adapted from [addyosmani/agent-skills/skills/code-simplification/SKILL.md](https://github.com/addyosmani/agent-skills/blob/main/skills/code-simplification/SKILL.md) — MIT, © Addy Osmani. Upstream is itself inspired by Anthropic's [Claude Code Simplifier plugin](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/code-simplifier/agents/code-simplifier.md) (Apache 2.0).

## Adaptation note for this repo

The skill content below is unmodified from Addy Osmani's upstream. Apply alongside this repo's `CLAUDE.md` §2 (Simplicity First) and §3 (Surgical Changes) — they share the same philosophy; this skill operationalizes them into a structured pass.
...
#### Boundary-check before deleting "dead" state
...
If the answer is "yes" or "I'm not sure", **keep the state** and document the boundary in a one-line comment instead of deleting. Cheap. The cost of a wrong deletion at a system boundary is a production incident your test suite couldn't catch.
